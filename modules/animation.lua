...
function AnimationModule.start(text)
    ...
    textLabel.TextColor3 = Color3.fromRGB(180, 30, 30)
    ...
    glowEffect.BackgroundColor3 = Color3.fromRGB(120, 20, 20)
